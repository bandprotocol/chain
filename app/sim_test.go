...
func TestFullAppSimulation(t *testing.T) {
	...
	require.Equal(t, "BandApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	require.Equal(t, "BandApp", newApp.Name())
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		{app.GetKey(oracletypes.StoreKey), newApp.GetKey(oracletypes.StoreKey), [][]byte{
			...
			oracletypes.RequestLastExpiredStoreKey,
			oracletypes.PendingResolveListStoreKey,
			oracletypes.RequestStoreKeyPrefix,
			oracletypes.ReportStoreKeyPrefix,
			oracletypes.ValidatorStatusKeyPrefix,
			oracletypes.ResultStoreKeyPrefix,
		}},
	}
