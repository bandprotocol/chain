...
func (app *Hook) handleMsgSubmitProposal(
	ctx sdk.Context, txHash []byte, msg *types.MsgSubmitProposal, evMap common.EvMap, msgJson common.JsDict,
) {
	...
	msgJson["proposal_id"] = proposalId
}

// handleMsgDeposit implements emitter handler for MsgDeposit.
func (h *Hook) handleMsgDeposit(
	ctx sdk.Context, txHash []byte, msg *types.MsgDeposit, msgJson common.JsDict,
) {
	...
	msgJson["title"] = proposal.GetTitle()
}

// handleMsgVote implements emitter handler for MsgVote.
func (h *Hook) handleMsgVote(
	ctx sdk.Context, txHash []byte, msg *types.MsgVote, msgJson common.JsDict,
) {
	h.Write("SET_VOTE", common.JsDict{
