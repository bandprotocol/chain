...
func (suite *DecoderTestSuite) TestDecodeMsgRequestData() {
	...
	suite.testCompareJson(
		detail,
		"{\"ask_count\":1,\"calldata\":\"Y2FsbGRhdGE=\",\"client_id\":\"cleint_id\",\"execute_gas\":300000,\"fee_limit\":[{\"denom\":\"uband\",\"amount\":\"100000000\"}],\"min_count\":1,\"oracle_script_id\":1,\"prepare_gas\":40000,\"sender\":\"band12djkuer9wgqqqqqqqqqqqqqqqqqqqqqqck96t0\",\"tss_encoder\":0}",
	)
}
...
func (suite *DecoderTestSuite) TestDecodeTunnelMsgCreateTunnel() {
	...
	msg, err := tunneltypes.NewMsgCreateTSSTunnel(
		...
		tunneltypes.TSS_ROUTE_ENCODER_TICK_ABI,
	...
	suite.testCompareJson(
		detail,
		"{\"creator\":\"band1gdex2ct5daeqqqqqqqqqqqqqqqqqqqqq8vcand\",\"initial_deposit\":[{\"denom\":\"uband\",\"amount\":\"5\"}],\"interval\":60,\"route\":{\"destination_chain_id\":\"ethereum\",\"destination_contract_address\":\"0xcabe9a5e6249c893a4b4fc263\",\"encoder\":2},\"route_type\":\"/band.tunnel.v1beta1.TSSRoute\",\"signal_deviations\":[{\"signal_id\":\"CS:BAND-USD\",\"soft_deviation_bps\":10000,\"hard_deviation_bps\":10000}]}",
	)
}
