...
var (
	...
	ErrInvalidTunnelCreator     = errorsmod.Register(ModuleName, 9, "invalid creator of tunnel")
	...
	ErrInvalidDepositDenom      = errorsmod.Register(ModuleName, 13, "invalid deposit denom")
	ErrDepositNotFound          = errorsmod.Register(ModuleName, 14, "deposit not found")
	ErrInsufficientFunds        = errorsmod.Register(ModuleName, 15, "insufficient funds")
	ErrInsufficientDeposit      = errorsmod.Register(ModuleName, 16, "insufficient deposit")
	ErrAlreadyActive            = errorsmod.Register(ModuleName, 17, "already active")
	ErrAlreadyInactive          = errorsmod.Register(ModuleName, 18, "already inactive")
)
