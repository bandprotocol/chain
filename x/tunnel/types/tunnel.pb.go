...
import (
	...
	types2 "github.com/bandprotocol/chain/v2/x/feeds/types"
...
type Tunnel struct {
	...
	FeedType types2.FeedType `protobuf:"varint,4,opt,name=feed_type,json=feedType,proto3,enum=feeds.v1beta1.FeedType" json:"feed_type,omitempty"`
...
func (m *Tunnel) GetFeedType() types2.FeedType {
	if m != nil {
		return m.FeedType
	}
	return types2.FEED_TYPE_UNSPECIFIED
}
...
var fileDescriptor_b5270a56045f1d8a = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FeedType |= types2.FeedType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
