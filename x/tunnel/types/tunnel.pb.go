...
const (
	...
	TSS_ROUTE_ENCODER_UNSPECIFIED TSSRouteEncoder = 0
	// TSS_ROUTE_ENCODER_FIXED_POINT_ABI is a fixed-point price abi encoder (price * 10^9).
	TSS_ROUTE_ENCODER_FIXED_POINT_ABI TSSRouteEncoder = 1
	// TSS_ROUTE_ENCODER_TICK_ABI is a tick abi encoder.
	TSS_ROUTE_ENCODER_TICK_ABI TSSRouteEncoder = 2
)

var TSSRouteEncoder_name = map[int32]string{
	0: "TSS_ROUTE_ENCODER_UNSPECIFIED",
	1: "TSS_ROUTE_ENCODER_FIXED_POINT_ABI",
	2: "TSS_ROUTE_ENCODER_TICK_ABI",
}

var TSSRouteEncoder_value = map[string]int32{
...
func (x TSSRouteEncoder) String() string {
	return proto.EnumName(TSSRouteEncoder_name, int32(x))
}
...
func init() {
	proto.RegisterEnum("band.tunnel.v1beta1.TSSRouteEncoder", TSSRouteEncoder_name, TSSRouteEncoder_value)
...
var fileDescriptor_6bb6151451ba2f25 = []byte{
	...
	,
}
...
func (m *Packet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.BaseFee = append(m.BaseFee, types1.Coin{})
		...
		case 6:
			...
			m.RouteFee = append(m.RouteFee, types1.Coin{})
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Encoder |= TSSRouteEncoder(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
