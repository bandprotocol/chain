...
// ActiveTunnelIDs is the type for a list of active tunnel IDs
type ActiveTunnelIDs struct {
	// IDs is the list of active tunnel IDs
	IDs []uint64 `protobuf:"varint,1,rep,packed,name=ids,proto3" json:"ids,omitempty"`
}

func (m *ActiveTunnelIDs) Reset()         { *m = ActiveTunnelIDs{} }
func (m *ActiveTunnelIDs) String() string { return proto.CompactTextString(m) }
func (*ActiveTunnelIDs) ProtoMessage()    {}
func (*ActiveTunnelIDs) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5270a56045f1d8a, []int{4}
}
func (m *ActiveTunnelIDs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ActiveTunnelIDs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ActiveTunnelIDs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ActiveTunnelIDs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ActiveTunnelIDs.Merge(m, src)
}
func (m *ActiveTunnelIDs) XXX_Size() int {
	return m.Size()
}
func (m *ActiveTunnelIDs) XXX_DiscardUnknown() {
	xxx_messageInfo_ActiveTunnelIDs.DiscardUnknown(m)
}

var xxx_messageInfo_ActiveTunnelIDs proto.InternalMessageInfo

func (m *ActiveTunnelIDs) GetIDs() []uint64 {
	if m != nil {
		return m.IDs
	}
	return nil
...
func (m *SignalPrice) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ActiveTunnelIDs)(nil), "tunnel.v1beta1.ActiveTunnelIDs")
...
var fileDescriptor_b5270a56045f1d8a = []byte{
	...
	,
}
...
func (this *ActiveTunnelIDs) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ActiveTunnelIDs)
	if !ok {
		that2, ok := that.(ActiveTunnelIDs)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ActiveTunnelIDs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ActiveTunnelIDs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ActiveTunnelIDs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ActiveTunnelIDs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ActiveTunnelIDs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ActiveTunnelIDs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ActiveTunnelIDs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
