...
func (m *Tunnel) GetPacketCount() uint64 {
	if m != nil {
...
func (m *TSSPacket) GetPacketID() uint64 {
	if m != nil {
		return m.PacketID
	}
	return 0
...
func (m *AxelarPacket) GetPacketID() uint64 {
	if m != nil {
		return m.PacketID
	}
	return 0
...
var fileDescriptor_b5270a56045f1d8a = []byte{
	...
	,
}
...
func (this *Tunnel) Equal(that interface{}) bool {
	...
	if this.PacketCount != that1.PacketCount {
		return false
	}
...
func (m *Tunnel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PacketCount != 0 {
		i = encodeVarintTunnel(dAtA, i, uint64(m.PacketCount))
		i--
		dAtA[i] = 0x10
	}
	if m.ID != 0 {
...
func (m *TSSPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PacketID != 0 {
		i = encodeVarintTunnel(dAtA, i, uint64(m.PacketID))
		i--
		dAtA[i] = 0x10
	}
	if m.TunnelID != 0 {
...
func (m *Tunnel) Size() (n int) {
	...
	if m.PacketCount != 0 {
		n += 1 + sovTunnel(uint64(m.PacketCount))
	}
	if m.Route != nil {
		l = m.Route.Size()
		n += 1 + l + sovTunnel(uint64(l))
...
func (m *TSSPacket) Size() (n int) {
	...
	if m.PacketID != 0 {
		n += 1 + sovTunnel(uint64(m.PacketID))
	}
	if m.FeedType != 0 {
		n += 1 + sovTunnel(uint64(m.FeedType))
	}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PacketID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
