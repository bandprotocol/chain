...
func (m *MockAccountKeeper) GetModuleAccount(ctx types2.Context, moduleName string) types3.ModuleAccountI {
	m.ctrl.T.Helper()
...
func (m *MockBankKeeper) SendCoinsFromModuleToModule(ctx types2.Context, senderModule, recipientModule string, amt types2.Coins) error {
	m.ctrl.T.Helper()
