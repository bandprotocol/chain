...
func (m *MockBandtssKeeper) IsReady(ctx types2.Context) bool {
	m.ctrl.T.Helper()
...
func (mr *MockBandtssKeeperMockRecorder) IsReady(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsReady", reflect.TypeOf((*MockBandtssKeeper)(nil).IsReady), ctx)
}
