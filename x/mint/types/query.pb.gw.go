...
var (
	pattern_Query_Parameters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"minting", "parameters"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Inflation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"minting", "parameters"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AnnualProvisions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"minting", "annual_provisions"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_EthIntegrationAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"minting", "eth_integration_address"}, "", runtime.AssumeColonVerbOpt(true)))
)
