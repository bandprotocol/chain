...
var (
	...
	ErrSignalPricesTooLarge      = errorsmod.Register(ModuleName, 15, "signal prices list is too large")
	...
	ErrSubmittedSignalsTooLarge  = errorsmod.Register(ModuleName, 19, "submitted signals list is too large")
)
