...
var (
	...
	ErrInvalidWeightedPriceArray = errorsmod.Register(ModuleName, 10, "invalid weighted price array")
	...
	ErrUnableToUndelegate        = errorsmod.Register(ModuleName, 19, "unable to undelegate")
	ErrInvalidSignalIDs          = errorsmod.Register(ModuleName, 20, "invalid signal ids")
	ErrInvalidFeedsType          = errorsmod.Register(ModuleName, 21, "invalid feeds type")
)
