...
// TODO: Reduce copy code and use embedded struct instead
import (
	"context"
	"encoding/json"
	"fmt"
	...
	"github.com/bandprotocol/chain/v3/x/bank/keeper"
)
...
// 			AppModuleBasic: bank.AppModuleBasic{cdc},
// 			cdc:            cdc,
// 		},
// 		keeper:         keeper,
...
// 	m := bankkeeper.NewMigrator(
// 		am.keeper.(keeper.WrappedBankKeeper).BaseKeeper,
// 		am.legacySubspace,
// 	)
...
type AppModule struct {
	...
	keeper        keeper.WrappedBankKeeper
	accountKeeper types.AccountKeeper
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	m := bankkeeper.NewMigrator(am.keeper.Keeper.(bankkeeper.BaseKeeper), am.legacySubspace)
	if err := cfg.RegisterMigration(types.ModuleName, 1, m.Migrate1to2); err != nil {
		panic(fmt.Sprintf("failed to migrate x/bank from version 1 to 2: %v", err))
	}
...
func (am AppModule) RegisterInvariants(ir sdk.InvariantRegistry) {
	bankkeeper.RegisterInvariants(ir, am.keeper)
}
...
// RegisterStoreDecoder registers a decoder for supply module's types
func (am AppModule) RegisterStoreDecoder(sdr simtypes.StoreDecoderRegistry) {
	sdr[types.StoreKey] = simtypes.NewStoreDecoderFuncFromCollectionsSchema(
		am.keeper.Keeper.(bankkeeper.BaseKeeper).Schema,
	)
}
...
type ModuleOutputs struct {
	...
	BankKeeper keeper.WrappedBankKeeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	bankKeeper := keeper.NewWrappedBankKeeperBurnToCommunityPool(
