...
type AuctionStatus struct {
	...
	// FinishBlock is the number of last block of auction duration
	FinishBlock uint64 `protobuf:"varint,2,opt,name=finish_block,json=finishBlock,proto3" json:"finish_block,omitempty"`
}
...
func (m *AuctionStatus) GetFinishBlock() uint64 {
	if m != nil {
...
var fileDescriptor_e3dc552ee3b806a8 = []byte{
	...
	,
}
...
func (m *AuctionStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.FinishBlock != 0 {
		i = encodeVarintAuction(dAtA, i, uint64(m.FinishBlock))
		i--
		dAtA[i] = 0x10
	}
	if m.Pending {
...
func (m *AuctionStatus) Size() (n int) {
	...
	if m.FinishBlock != 0 {
		n += 1 + sovAuction(uint64(m.FinishBlock))
	}
	return n
}
...
func (m *AuctionStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FinishBlock", wireType)
			}
			m.FinishBlock = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FinishBlock |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
