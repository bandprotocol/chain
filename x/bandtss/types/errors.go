...
var (
	...
	ErrSigningNotFound       = errors.Register(ModuleName, 9, "signing not found")
	ErrMemberNotFound        = errors.Register(ModuleName, 10, "member not found")
	ErrMemberAlreadyExists   = errors.Register(ModuleName, 11, "member already exists")
	ErrMemberAlreadyActive   = errors.Register(ModuleName, 12, "member already active")
)
