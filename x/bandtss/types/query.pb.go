...
type QuerySigningResponse struct {
	...
	CurrentGroupSigningResult types1.SigningResult `protobuf:"bytes,3,opt,name=current_group_signing_result,json=currentGroupSigningResult,proto3" json:"current_group_signing_result"`
	// replacing_group_signing_result is the signing result from the replacing group.
	ReplacingGroupSigningResult types1.SigningResult `protobuf:"bytes,4,opt,name=replacing_group_signing_result,json=replacingGroupSigningResult,proto3" json:"replacing_group_signing_result"`
}
...
var fileDescriptor_85d3a287ab772b87 = []byte{
	...
	,
}
