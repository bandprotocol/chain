...
type Group struct {
	...
	// PubKey is the public key generated by the group after successful completion of the DKG process.
	...
	// ExpiryTime is the time when the group will be dissolved if it has not finished its process.
...
type Round1Info struct {
	// MemberID is the unique identifier of a group member.
	...
	// CoefficientsCommit is a list of commitments to the coefficients of the member's secret polynomial.
	...
	// OneTimePubKey is the one-time public key used by the member to encrypt secret shares.
	...
	// A0Sig is the member's signature on the first coefficient of its secret polynomial.
	...
	// OneTimeSig is the member's signature on its one-time public key.
...
type Round2Info struct {
	// MemberID is the unique identifier of a group member.
	MemberID github_com_bandprotocol_chain_v2_pkg_tss.MemberID `protobuf:"varint,1,opt,name=member_id,json=memberId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.MemberID" json:"member_id,omitempty"`
	// EncryptedSecretShares is a list of secret shares encrypted under the public keys of other members.
...
type DE struct {
	// PubD is the public part of a member's decryption key.
	...
	// PubE is the public part of a member's encryption key.
...
type Signing struct {
	// SigningID is the unique identifier of the signing process.
	...
	// AssignedMembers is a list of members assigned to the signing process.
	...
	// GroupPubNonce is the public nonce generated by the group for this signing process.
	...
	// RequestTime is the time when the signing request was made.
	RequestTime time.Time `protobuf:"bytes,8,opt,name=request_time,json=requestTime,proto3,stdtime" json:"request_time"`
	// ExpiryTime is the time when the signing request will expire if not completed.
...
type AssignedMember struct {
	...
	// PubNonce is the public nonce of the member for the signing process.
...
type PendingSignings struct {
	// SigningIds is a list of identifiers for the signing processes.
...
type Member struct {
	...
	// PubKey is the public key of the member.
	...
	// IsMalicious is a boolean flag indicating whether the member is considered malicious.
...
type Confirm struct {
	// MemberID is the unique identifier of a group member.
	MemberID github_com_bandprotocol_chain_v2_pkg_tss.MemberID `protobuf:"varint,1,opt,name=member_id,json=memberId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.MemberID" json:"member_id,omitempty"`
	// OwnPubKeySig is a signature over the member's own public key.
...
type Complaint struct {
	...
	// key_sym is a symmetric key which is the reason for the complaint. It seems like
	// it might contain some information relevant to the complaint.
	...
	// signature is the signature that validates the complaint made by the complainer.
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
