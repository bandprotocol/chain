...
type EVMSignature struct {
	// address is the address of the nonce for using in the contract.
...
func (m *EVMSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EVMSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
