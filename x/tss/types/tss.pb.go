...
type Group struct {
	...
	// last_replaced_groups is the last replacing of this group.
	LastReplacedGroup *ReplacedGroup `protobuf:"bytes,5,opt,name=last_replaced_group,json=lastReplacedGroup,proto3" json:"last_replaced_group,omitempty"`
	// status represents the current stage of the group in the DKG or signing process.
	Status GroupStatus `protobuf:"varint,6,opt,name=status,proto3,enum=tss.v1beta1.GroupStatus" json:"status,omitempty"`
...
func (m *Group) GetLastReplacedGroup() *ReplacedGroup {
	if m != nil {
		return m.LastReplacedGroup
	}
	return nil
}
...
type Signing struct {
	...
	Message github_com_cometbft_cometbft_libs_bytes.HexBytes `protobuf:"bytes,4,opt,name=message,proto3,casttype=github.com/cometbft/cometbft/libs/bytes.HexBytes" json:"message,omitempty"`
...
// ReplacedGroup represents a replacing of the group
type ReplacedGroup struct {
	// old_pub_key is the public key of the old group.
	OldPubKey github_com_bandprotocol_chain_v2_pkg_tss.Point `protobuf:"bytes,1,opt,name=old_pub_key,json=oldPubKey,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.Point" json:"old_pub_key,omitempty"`
	// signing_id is the unique identifier of the signing that used to change public key.
...
func (m *ReplacedGroup) Reset()         { *m = ReplacedGroup{} }
func (m *ReplacedGroup) String() string { return proto.CompactTextString(m) }
func (*ReplacedGroup) ProtoMessage()    {}
func (*ReplacedGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_321be6f53cb0491e, []int{17}
}
func (m *ReplacedGroup) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReplacedGroup) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReplacedGroup.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReplacedGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplacedGroup.Merge(m, src)
}
func (m *ReplacedGroup) XXX_Size() int {
	return m.Size()
}
func (m *ReplacedGroup) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplacedGroup.DiscardUnknown(m)
}

var xxx_messageInfo_ReplacedGroup proto.InternalMessageInfo

func (m *ReplacedGroup) GetOldPubKey() github_com_bandprotocol_chain_v2_pkg_tss.Point {
	if m != nil {
		return m.OldPubKey
	}
	return nil
...
func (m *ReplacedGroup) GetSigningID() github_com_bandprotocol_chain_v2_pkg_tss.SigningID {
	if m != nil {
		return m.SigningID
	}
	return 0
...
func (m *TextRequestSignature) GetMessage() github_com_cometbft_cometbft_libs_bytes.HexBytes {
	if m != nil {
		return m.Message
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ReplacedGroup)(nil), "tss.v1beta1.ReplacedGroup")
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
...
func (this *Group) Equal(that interface{}) bool {
	...
	if !this.LastReplacedGroup.Equal(that1.LastReplacedGroup) {
		return false
	}
...
func (this *ReplacedGroup) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplacedGroup)
	if !ok {
		that2, ok := that.(ReplacedGroup)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !bytes.Equal(this.OldPubKey, that1.OldPubKey) {
		return false
	}
	if this.SigningID != that1.SigningID {
		return false
...
func (m *Group) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastReplacedGroup != nil {
		{
			size, err := m.LastReplacedGroup.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PendingReplaceGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n11, err11 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.ExecTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.ExecTime):])
	if err11 != nil {
		return 0, err11
	}
	i -= n11
	i = encodeVarintTss(dAtA, i, uint64(n11))
	i--
	dAtA[i] = 0x22
	if m.ToGroupID != 0 {
...
func (m *ReplacedGroup) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReplacedGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplacedGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.OldPubKey) > 0 {
		...
		i = encodeVarintTss(dAtA, i, uint64(len(m.OldPubKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ReplacedGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Group) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastReplacedGroup", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LastReplacedGroup == nil {
				m.LastReplacedGroup = &ReplacedGroup{}
			}
			if err := m.LastReplacedGroup.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *ReplacedGroup) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplacedGroup: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplacedGroup: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.OldPubKey = append(m.OldPubKey[:0], dAtA[iNdEx:postIndex]...)
			if m.OldPubKey == nil {
				m.OldPubKey = []byte{}
			}
			iNdEx = postIndex
