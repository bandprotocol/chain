...
// DefaultReqeustSignature defines a standard request signature.
type DefaultRequestSignature struct {
	// message is the data that needs to be signed.
	Message []byte `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
}

func (m *DefaultRequestSignature) Reset()         { *m = DefaultRequestSignature{} }
func (m *DefaultRequestSignature) String() string { return proto.CompactTextString(m) }
func (*DefaultRequestSignature) ProtoMessage()    {}
func (*DefaultRequestSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_321be6f53cb0491e, []int{17}
}
func (m *DefaultRequestSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DefaultRequestSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DefaultRequestSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DefaultRequestSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DefaultRequestSignature.Merge(m, src)
}
func (m *DefaultRequestSignature) XXX_Size() int {
	return m.Size()
}
func (m *DefaultRequestSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_DefaultRequestSignature.DiscardUnknown(m)
}

var xxx_messageInfo_DefaultRequestSignature proto.InternalMessageInfo

func (m *DefaultRequestSignature) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DefaultRequestSignature)(nil), "tss.v1beta1.DefaultRequestSignature")
}
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
...
func (this *DefaultRequestSignature) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DefaultRequestSignature)
	if !ok {
		that2, ok := that.(DefaultRequestSignature)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *Status) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n3, err3 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.LastActive, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.LastActive):])
	if err3 != nil {
		return 0, err3
	}
	i -= n3
...
func (m *DefaultRequestSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DefaultRequestSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DefaultRequestSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DefaultRequestSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DefaultRequestSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DefaultRequestSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DefaultRequestSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
