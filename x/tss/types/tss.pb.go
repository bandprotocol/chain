...
type Status struct {
	// group_id is the unique identifier of a group.
	GroupID github_com_bandprotocol_chain_v2_pkg_tss.GroupID `protobuf:"varint,1,opt,name=group_id,json=groupId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.GroupID" json:"group_id,omitempty"`
	// member_id is the unique identifier of a member.
	...
	// is_active is a boolean indicating active status of member.
	// The member will be deactivated when they are unable to send signature before the signing expired.
...
func (m *Status) GetGroupID() github_com_bandprotocol_chain_v2_pkg_tss.GroupID {
	if m != nil {
		return m.GroupID
	}
	return 0
...
func (m *Status) GetMemberID() github_com_bandprotocol_chain_v2_pkg_tss.MemberID {
	if m != nil {
		return m.MemberID
	}
	return 0
...
func (m *Status) GetIsActive() bool {
	if m != nil {
		return m.IsActive
	}
	return false
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
