...
type Replacement struct {
	...
	FromGroupID github_com_bandprotocol_chain_v2_pkg_tss.GroupID `protobuf:"varint,3,opt,name=from_group_id,json=fromGroupId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.GroupID" json:"from_group_id,omitempty"`
	// from_pub_key is the public key of the group that want to replace.
	FromPubKey github_com_bandprotocol_chain_v2_pkg_tss.Point `protobuf:"bytes,4,opt,name=from_pub_key,json=fromPubKey,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.Point" json:"from_pub_key,omitempty"`
	// to_group_id is the ID of the group that will take the place of another group.
	ToGroupID github_com_bandprotocol_chain_v2_pkg_tss.GroupID `protobuf:"varint,5,opt,name=to_group_id,json=toGroupId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.GroupID" json:"to_group_id,omitempty"`
	// to_pub_key is the public key of the group that will take the place of another group.
	ToPubKey github_com_bandprotocol_chain_v2_pkg_tss.Point `protobuf:"bytes,6,opt,name=to_pub_key,json=toPubKey,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.Point" json:"to_pub_key,omitempty"`
...
func (m *Replacement) GetFromGroupID() github_com_bandprotocol_chain_v2_pkg_tss.GroupID {
	if m != nil {
...
func (m *Replacement) GetFromPubKey() github_com_bandprotocol_chain_v2_pkg_tss.Point {
	if m != nil {
		return m.FromPubKey
	}
	return nil
...
func (m *Replacement) GetToGroupID() github_com_bandprotocol_chain_v2_pkg_tss.GroupID {
	if m != nil {
		return m.ToGroupID
	}
	return 0
...
func (m *Replacement) GetToPubKey() github_com_bandprotocol_chain_v2_pkg_tss.Point {
	if m != nil {
		return m.ToPubKey
	}
	return nil
...
type TextRequestingSignature struct {
...
func (m *TextRequestingSignature) Reset()         { *m = TextRequestingSignature{} }
func (m *TextRequestingSignature) String() string { return proto.CompactTextString(m) }
func (*TextRequestingSignature) ProtoMessage()    {}
func (*TextRequestingSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_321be6f53cb0491e, []int{18}
}
func (m *TextRequestingSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TextRequestingSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TextRequestingSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TextRequestingSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TextRequestingSignature.Merge(m, src)
}
func (m *TextRequestingSignature) XXX_Size() int {
	return m.Size()
}
func (m *TextRequestingSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_TextRequestingSignature.DiscardUnknown(m)
}

var xxx_messageInfo_TextRequestingSignature proto.InternalMessageInfo

func (m *TextRequestingSignature) GetMessage() github_com_cometbft_cometbft_libs_bytes.HexBytes {
	if m != nil {
		return m.Message
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TextRequestingSignature)(nil), "tss.v1beta1.TextRequestingSignature")
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
...
func (this *Replacement) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.FromPubKey, that1.FromPubKey) {
		return false
	}
	if this.ToGroupID != that1.ToGroupID {
		return false
	}
	if !bytes.Equal(this.ToPubKey, that1.ToPubKey) {
		return false
	}
	if this.Status != that1.Status {
		return false
...
func (this *TextRequestingSignature) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TextRequestingSignature)
	if !ok {
		that2, ok := that.(TextRequestingSignature)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *Replacement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ToPubKey) > 0 {
		i -= len(m.ToPubKey)
		copy(dAtA[i:], m.ToPubKey)
		i = encodeVarintTss(dAtA, i, uint64(len(m.ToPubKey)))
		i--
		dAtA[i] = 0x32
	}
	if m.ToGroupID != 0 {
	...
	if len(m.FromPubKey) > 0 {
		...
		i = encodeVarintTss(dAtA, i, uint64(len(m.FromPubKey)))
		i--
		dAtA[i] = 0x22
	}
	if m.FromGroupID != 0 {
...
func (m *TextRequestingSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TextRequestingSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TextRequestingSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TextRequestingSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Replacement) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ToPubKey = append(m.ToPubKey[:0], dAtA[iNdEx:postIndex]...)
			if m.ToPubKey == nil {
				m.ToPubKey = []byte{}
			}
			iNdEx = postIndex
...
func (m *TextRequestingSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TextRequestingSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TextRequestingSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
