...
type Group struct {
	...
	// expired_time is the time when the group will be dissolved if it has not finished its process.
	ExpiredTime *time.Time `protobuf:"bytes,7,opt,name=expired_time,json=expiredTime,proto3,stdtime" json:"expired_time,omitempty"`
}
...
func (m *Group) GetExpiredTime() *time.Time {
	if m != nil {
...
type Signing struct {
	...
	// expired_time is the time when the signing request will expire if not completed.
	ExpiredTime *time.Time `protobuf:"bytes,9,opt,name=expired_time,json=expiredTime,proto3,stdtime" json:"expired_time,omitempty"`
}
...
func (m *Signing) GetExpiredTime() *time.Time {
	if m != nil {
		return m.ExpiredTime
	}
	return nil
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
...
func (this *Group) Equal(that interface{}) bool {
	...
	if that1.ExpiredTime == nil {
		if this.ExpiredTime != nil {
			return false
		}
	} else if !this.ExpiredTime.Equal(*that1.ExpiredTime) {
		return false
	}
	return true
}
...
func (m *Signing) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ExpiredTime != nil {
		n3, err3 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ExpiredTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ExpiredTime):])
		if err3 != nil {
			return 0, err3
		}
		i -= n3
