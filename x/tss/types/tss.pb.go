...
// PendingProcessGroup represents a group that is pending in the DKG process.
type PendingProcessGroup struct {
	// group_id is the unique identifier of the group.
	GroupID github_com_bandprotocol_chain_v2_pkg_tss.GroupID `protobuf:"varint,1,opt,name=group_id,json=groupId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.GroupID" json:"group_id,omitempty"`
	// status represents the current stage of the group in the DKG process.
	Status GroupStatus `protobuf:"varint,2,opt,name=status,proto3,enum=tss.v1beta1.GroupStatus" json:"status,omitempty"`
}

func (m *PendingProcessGroup) Reset()         { *m = PendingProcessGroup{} }
func (m *PendingProcessGroup) String() string { return proto.CompactTextString(m) }
func (*PendingProcessGroup) ProtoMessage()    {}
func (*PendingProcessGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_321be6f53cb0491e, []int{14}
}
func (m *PendingProcessGroup) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PendingProcessGroup) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PendingProcessGroup.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PendingProcessGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PendingProcessGroup.Merge(m, src)
}
func (m *PendingProcessGroup) XXX_Size() int {
	return m.Size()
}
func (m *PendingProcessGroup) XXX_DiscardUnknown() {
	xxx_messageInfo_PendingProcessGroup.DiscardUnknown(m)
}

var xxx_messageInfo_PendingProcessGroup proto.InternalMessageInfo

func (m *PendingProcessGroup) GetGroupID() github_com_bandprotocol_chain_v2_pkg_tss.GroupID {
	if m != nil {
		return m.GroupID
	}
	return 0
...
func (m *PendingProcessGroup) GetStatus() GroupStatus {
	if m != nil {
		return m.Status
	}
	return GROUP_STATUS_UNSPECIFIED
...
type PendingProcessGroups struct {
	// pending_process_groups is the list of pending_process_group.
	PendingProcessGroups []PendingProcessGroup `protobuf:"bytes,1,rep,name=pending_process_groups,json=pendingProcessGroups,proto3" json:"pending_process_groups"`
}
...
func (m *PendingProcessGroups) GetPendingProcessGroups() []PendingProcessGroup {
	if m != nil {
		return m.PendingProcessGroups
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*PendingProcessGroup)(nil), "tss.v1beta1.PendingProcessGroup")
...
var fileDescriptor_321be6f53cb0491e = []byte{
	...
	,
}
...
func (this *PendingProcessGroup) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*PendingProcessGroup)
	if !ok {
		that2, ok := that.(PendingProcessGroup)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *PendingProcessGroups) Equal(that interface{}) bool {
	...
	if len(this.PendingProcessGroups) != len(that1.PendingProcessGroups) {
		return false
	}
	for i := range this.PendingProcessGroups {
		if !this.PendingProcessGroups[i].Equal(&that1.PendingProcessGroups[i]) {
			return false
		}
	}
	return true
...
func (m *Status) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n3, err3 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Since, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Since):])
	if err3 != nil {
		return 0, err3
	}
	i -= n3
...
func (m *PendingProcessGroup) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PendingProcessGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PendingProcessGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PendingProcessGroups) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PendingProcessGroups) > 0 {
		for iNdEx := len(m.PendingProcessGroups) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PendingProcessGroups[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *PendingProcessGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PendingProcessGroups) Size() (n int) {
	...
	_ = l
	if len(m.PendingProcessGroups) > 0 {
		for _, e := range m.PendingProcessGroups {
			l = e.Size()
			n += 1 + l + sovTss(uint64(l))
		}
	}
...
func (m *PendingProcessGroup) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PendingProcessGroup: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PendingProcessGroup: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PendingProcessGroups) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingProcessGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PendingProcessGroups = append(m.PendingProcessGroups, PendingProcessGroup{})
			if err := m.PendingProcessGroups[len(m.PendingProcessGroups)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
