...
var (
	...
	ErrBadDrbgInitialization            = sdkerrors.Register(ModuleName, 26, "bad drbg initialization")
	ErrPartialSigNotFound               = sdkerrors.Register(ModuleName, 27, "partial sig not found")
	ErrInvalidArgument                  = sdkerrors.Register(ModuleName, 28, "invalid argument")
	ErrSigningNotFound                  = sdkerrors.Register(ModuleName, 29, "signing not found")
	ErrAlreadySigned                    = sdkerrors.Register(ModuleName, 30, "already signed")
	ErrSigningAlreadySuccess            = sdkerrors.Register(ModuleName, 31, "signing already success")
	ErrPubNonceNotEqualToSigR           = sdkerrors.Register(ModuleName, 32, "public nonce not equal to signature r")
	ErrMemberNotAssigned                = sdkerrors.Register(ModuleName, 33, "member is not assigned participants")
	ErrVerifySigningSigFailed           = sdkerrors.Register(ModuleName, 34, "failed to verify signing signature")
	ErrCombineSigsFailed                = sdkerrors.Register(ModuleName, 35, "failed to combine signatures")
	ErrVerifyGroupSigningSigFailed      = sdkerrors.Register(
		ModuleName,
		36,
		"failed to verify group signing signature",
	)
	ErrDEQueueFull    = sdkerrors.Register(ModuleName, 37, "DE queue is full")
	ErrSigningExpired = sdkerrors.Register(ModuleName, 38, "signing expired")
)
