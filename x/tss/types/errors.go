...
var (
	...
	ErrRound1CommitmentsNotFound             = sdkerrors.Register(ModuleName, 7, "round 1 data not found")
	...
	ErrRound2DataNotFound                    = sdkerrors.Register(ModuleName, 14, "round2 data not found")
