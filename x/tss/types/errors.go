...
var (
	...
	ErrComplainFailed                   = sdkerrors.Register(ModuleName, 21, "complain failed")
	ErrConfirmFailed                    = sdkerrors.Register(ModuleName, 22, "confirm failed")
	ErrConfirmNotFound                  = sdkerrors.Register(ModuleName, 23, "confirm not found")
	ErrComplainsWithStatusNotFound      = sdkerrors.Register(ModuleName, 24, "complaints with status not found")
	ErrDENotFound                       = sdkerrors.Register(ModuleName, 25, "DE not found")
	ErrGroupIsNotActive                 = sdkerrors.Register(ModuleName, 26, "group is not active")
	ErrUnexpectedThreshold              = sdkerrors.Register(ModuleName, 27, "threshold value is unexpected")
	ErrBadDrbgInitialization            = sdkerrors.Register(ModuleName, 28, "bad drbg initialization")
	ErrPartialSigNotFound               = sdkerrors.Register(ModuleName, 29, "partial sig not found")
	ErrInvalidArgument                  = sdkerrors.Register(ModuleName, 30, "invalid argument")
	ErrSigningNotFound                  = sdkerrors.Register(ModuleName, 31, "signing not found")
	ErrAlreadySigned                    = sdkerrors.Register(ModuleName, 32, "already signed")
	ErrSigningAlreadySuccess            = sdkerrors.Register(ModuleName, 33, "signing already success")
	ErrPubNonceNotEqualToSigR           = sdkerrors.Register(ModuleName, 34, "public nonce not equal to signature r")
	ErrMemberNotAssigned                = sdkerrors.Register(ModuleName, 35, "member is not assigned participants")
	ErrVerifySigningSigFailed           = sdkerrors.Register(ModuleName, 36, "failed to verify signing signature")
	ErrCombineSigsFailed                = sdkerrors.Register(ModuleName, 37, "failed to combine signatures")
	ErrVerifyGroupSigningSigFailed      = sdkerrors.Register(
		ModuleName,
		38,
		"failed to verify group signing signature",
	)
	ErrDEQueueFull    = sdkerrors.Register(ModuleName, 39, "DE queue is full")
	ErrSigningExpired = sdkerrors.Register(ModuleName, 40, "signing expired")
)
