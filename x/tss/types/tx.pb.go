...
type MsgSubmitDKGRound1 struct {
	...
	CoefficientsCommit []types.Any `protobuf:"bytes,2,rep,name=coefficients_commit,json=coefficientsCommit,proto3" json:"coefficients_commit"`
	// one_time_pub_key is a one-time used public key for sending secret shares.
	OneTimePubKey *types.Any `protobuf:"bytes,3,opt,name=one_time_pub_key,json=oneTimePubKey,proto3" json:"one_time_pub_key,omitempty"`
	// a0_sing is a proof of knowledge on a0.
	A0Sing *types.Any `protobuf:"bytes,4,opt,name=a0_sing,json=a0Sing,proto3" json:"a0_sing,omitempty"`
	// one_time_sign is a proof of knowledge on the OneTimePublicKey.
	OneTimeSign *types.Any `protobuf:"bytes,5,opt,name=one_time_sign,json=oneTimeSign,proto3" json:"one_time_sign,omitempty"`
	// sender is an account address of message sender.
...
func (m *MsgSubmitDKGRound1) GetCoefficientsCommit() []types.Any {
	if m != nil {
...
func (m *MsgSubmitDKGRound1) GetOneTimePubKey() *types.Any {
	if m != nil {
...
func (m *MsgSubmitDKGRound1) GetA0Sing() *types.Any {
	if m != nil {
		return m.A0Sing
	}
	return nil
...
func (m *MsgSubmitDKGRound1) GetOneTimeSign() *types.Any {
	if m != nil {
...
var fileDescriptor_58d13e1023e3ffaf = []byte{
	...
	,
}
...
func (m *MsgSubmitDKGRound1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OneTimeSign != nil {
		{
			size, err := m.OneTimeSign.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.A0Sing != nil {
		{
			size, err := m.A0Sing.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.OneTimePubKey != nil {
		{
			size, err := m.OneTimePubKey.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgSubmitDKGRound1) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.CoefficientsCommit = append(m.CoefficientsCommit, types.Any{})
		...
		case 3:
			...
			if m.OneTimePubKey == nil {
				m.OneTimePubKey = &types.Any{}
			}
			if err := m.OneTimePubKey.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field A0Sing", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.A0Sing.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			if m.OneTimeSign == nil {
				m.OneTimeSign = &types.Any{}
			}
			if err := m.OneTimeSign.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
