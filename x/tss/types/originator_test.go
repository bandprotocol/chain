...
func TestEncodeTunnelOriginator(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: "a466d313088002122a3078353636326163353331413237333743336442383930314539383242343333323761326644653261651a03425343",
		},
	}
...
func TestEncodeDirectOriginator(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: "3c839c260a2b62616e64313064303779323635676d6d757674347a30773961773838306a6e73723730306a72646e38776d120474657374",
		},
	}
