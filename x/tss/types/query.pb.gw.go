...
var (
	...
	pattern_Query_Members_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"tss", "v1beta1", "groups", "group_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
