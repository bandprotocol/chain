...
func TestGetSetParams(t *testing.T) {
	...
	expectedParams := types.Params{
		...
		MaxConcurrentResolvingRequests: 1,
	}
	...
	require.Equal(t, expectedParams.MaxConcurrentResolvingRequests, k.MaxConcurrentResolvingRequests(ctx))
	expectedParams = types.Params{
		...
		MaxConcurrentResolvingRequests: 4,
	}
	k.SetParams(ctx, expectedParams)
	require.Equal(t, expectedParams, k.GetParams(ctx))
	require.Equal(t, expectedParams.MaxRawRequestCount, k.MaxRawRequestCount(ctx))
