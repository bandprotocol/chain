...
func TestHasRequest(t *testing.T) {
	...
	k.SetRequest(ctx, 42, types.NewRequest(1, BasicCalldata, nil, 1, 1, testapp.ParseTime(0), "", nil, nil, 0, 0))
...
func TestSetterGetterRequest(t *testing.T) {
	...
	req1 := types.NewRequest(1, BasicCalldata, nil, 1, 1, testapp.ParseTime(0), "", nil, nil, 0, 0)
	req2 := types.NewRequest(2, BasicCalldata, nil, 1, 1, testapp.ParseTime(0), "", nil, nil, 0, 0)
...
func TestAddDataSourceBasic(t *testing.T) {
	...
	id := k.AddRequest(ctx, types.NewRequest(42, BasicCalldata, []sdk.ValAddress{}, 1, 1, testapp.ParseTime(0), "", nil, nil, 0, 0))
