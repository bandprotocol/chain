...
//	if err != nil {
//		return commontypes.QueryBadRequest(legacyQuerierCdc, err.Error())
//	}
//	dataSource, err := k.GetDataSource(ctx, types.DataSourceID(id))
//	if err != nil {
//		return commontypes.QueryNotFound(legacyQuerierCdc, err.Error())
//	}
//	return commontypes.QueryOK(legacyQuerierCdc, dataSource)
//}
//
...
//		return commontypes.QueryNotFound(legacyQuerierCdc, err.Error())
//	}
//	return commontypes.QueryOK(legacyQuerierCdc, oracleScript)
//}
//
...
//		return commontypes.QueryOK(legacyQuerierCdc, types.QueryRequestResult{
//			Request: request,
//			Reports: reports,
//			Result:  nil,
//		})
...
//		return commontypes.QueryBadRequest(legacyQuerierCdc, err.Error())
//	}
//	return commontypes.QueryOK(legacyQuerierCdc, k.GetValidatorStatus(ctx, validatorAddress))
//}
//
...
//		return commontypes.QueryBadRequest(legacyQuerierCdc, err.Error())
//	}
//	return commontypes.QueryOK(legacyQuerierCdc, k.GetReporters(ctx, validatorAddress))
//}
//
...
//			return false
//		})
//	return commontypes.QueryOK(legacyQuerierCdc, vals)
//}
//
...
//	if len(path) > 1 {
//		return commontypes.QueryBadRequest(legacyQuerierCdc, "too many arguments")
//	}
//
...
//	return commontypes.QueryOK(legacyQuerierCdc, res)
//}
//
//// TODO: refactor to k.cdc
//func queryDataProvidersPool(ctx sdk.Context, k Keeper) ([]byte, error) {
//	return commontypes.QueryOK(legacyQuerierCdc, k.GetOraclePool(ctx).DataProvidersPool)
//}
