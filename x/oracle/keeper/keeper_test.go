...
func TestGetSetParams(t *testing.T) {
	...
	k.SetDataRequesterBasicFeeParam(ctx, oracletypes.DefaultDataRequesterBasicFee)
	require.Equal(t, oracletypes.NewParams(1, 10, 30, 50000, 3000, 3, 50, 1000, 1*1024, 1*1024, oracletypes.DefaultDataProviderRewardPerByte, oracletypes.DefaultDataRequesterBasicFee), k.GetParams(ctx))
	...
	k.SetDataProviderRewardPerByteParam(ctx, oracletypes.DefaultDataProviderRewardPerByte)
	k.SetDataRequesterBasicFeeParam(ctx, oracletypes.DefaultDataRequesterBasicFee)
	require.Equal(t, oracletypes.NewParams(2, 20, 40, 150000, 30000, 5, 80, 10000, 1*1024, 1*1024, oracletypes.DefaultDataProviderRewardPerByte, oracletypes.DefaultDataRequesterBasicFee), k.GetParams(ctx))
}
