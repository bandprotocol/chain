...
type QueryRequestSearchRequest struct {
	...
	// Limit is maximum number of oracle requests to be included in the response
	// set limit to 1 to get latest request
...
func (m *QueryRequestSearchRequest) GetLimit() uint64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
type QueryRequestSearchResponse struct {
	...
	Requests []*QueryRequestResponse `protobuf:"bytes,1,rep,name=requests,proto3" json:"requests,omitempty"`
}
...
func (m *QueryRequestSearchResponse) GetRequests() []*QueryRequestResponse {
	if m != nil {
		return m.Requests
	}
	return nil
...
var fileDescriptor_34238c8dfdfcd7ec = []byte{
	...
	,
}
...
func (m *QueryRequestSearchResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Requests = append(m.Requests, &QueryRequestResponse{})
