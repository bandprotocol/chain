...
var (
	...
	ErrTooLongRequestKey               = sdkerrors.Register(ModuleName, 43, "too long request key")
	ErrInvalidDepositRequestPoolAmount = sdkerrors.Register(ModuleName, 44, "invalid deposit request pool amount")
)
