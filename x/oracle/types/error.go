...
var (
	...
	ErrInvalidRequestID         = errorsmod.Register(ModuleName, 48, "invalid request id")
	ErrInvalidOracleEncodeType  = errorsmod.Register(ModuleName, 49, "invalid oracle encode type")
)
