...
// OracleResultRequestSignature defines a rquest id to request TSS signature from the oracle result.
type OracleResultRequestSignature struct {
	// RequestID is BandChain's unique identifier for this oracle request.
	RequestID RequestID `protobuf:"varint,1,opt,name=request_id,json=requestId,proto3,casttype=RequestID" json:"request_id,omitempty"`
}

func (m *OracleResultRequestSignature) Reset()         { *m = OracleResultRequestSignature{} }
func (m *OracleResultRequestSignature) String() string { return proto.CompactTextString(m) }
func (*OracleResultRequestSignature) ProtoMessage()    {}
func (*OracleResultRequestSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_652b57db11528d07, []int{18}
}
func (m *OracleResultRequestSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OracleResultRequestSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OracleResultRequestSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OracleResultRequestSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OracleResultRequestSignature.Merge(m, src)
}
func (m *OracleResultRequestSignature) XXX_Size() int {
	return m.Size()
}
func (m *OracleResultRequestSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_OracleResultRequestSignature.DiscardUnknown(m)
}

var xxx_messageInfo_OracleResultRequestSignature proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*OracleResultRequestSignature)(nil), "oracle.v1.OracleResultRequestSignature")
}
...
var fileDescriptor_652b57db11528d07 = []byte{
	...
	0xf5, 0x8f, 0x1f, 0x49, 0x7c, 0x8f, 0x9d, 0x57, 0x75, 0x3a, 0xed, 0xce, 0xf4, 0x3f, 0xce, 0x3f,
	...
	0xaf, 0x7a, 0xc4, 0xc3, 0x38, 0x44, 0x96, 0x91, 0x2e, 0x76, 0x37, 0xd7, 0xfb, 0x61, 0x3f, 0x54,
	0xda, 0x86, 0xfc, 0xa5, 0x1d, 0x36, 0x6b, 0xfd, 0x30, 0xec, 0x7b, 0xb4, 0xa1, 0xa4, 0xde, 0xe0,
	...
	,
	...
	,
}
...
func (m *OracleResultRequestSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OracleResultRequestSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OracleResultRequestSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OracleResultRequestSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OracleResultRequestSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OracleResultRequestSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OracleResultRequestSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
