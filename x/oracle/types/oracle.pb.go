...
type Request struct {
	...
	// TSSGroupID is ID of the group that assign for sign the result data on tss module.
	TSSGroupID github_com_bandprotocol_chain_v2_pkg_tss.GroupID `protobuf:"varint,11,opt,name=tss_group_id,json=tssGroupId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.GroupID" json:"tss_group_id,omitempty"`
	// TSSEncodeType is the encode type of oracle result that will be sent to TSS.
	TSSEncodeType EncodeType `protobuf:"varint,12,opt,name=tss_encode_type,json=tssEncodeType,proto3,enum=oracle.v1.EncodeType" json:"tss_encode_type,omitempty"`
	// request is the address of requester
	Requester string `protobuf:"bytes,13,opt,name=requester,proto3" json:"requester,omitempty"`
	// fee_limit is the fee left for paying fee in this request.
	FeeLimit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,14,rep,name=fee_limit,json=feeLimit,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"fee_limit"`
}
...
func (m *Request) GetTSSGroupID() github_com_bandprotocol_chain_v2_pkg_tss.GroupID {
	if m != nil {
		return m.TSSGroupID
	}
	return 0
...
type OracleRequestPacketData struct {
	...
	// TSSGroupID is ID of the group that assign for sign the result data on tss module.
	TSSGroupID github_com_bandprotocol_chain_v2_pkg_tss.GroupID `protobuf:"varint,9,opt,name=tss_group_id,json=tssGroupId,proto3,casttype=github.com/bandprotocol/chain/v2/pkg/tss.GroupID" json:"tss_group_id,omitempty"`
	// TSSEncodeType is the encode type of oracle result that will be sent to TSS.
...
func (m *OracleRequestPacketData) GetTSSGroupID() github_com_bandprotocol_chain_v2_pkg_tss.GroupID {
	if m != nil {
		return m.TSSGroupID
	}
	return 0
...
func (m *SigningResult) GetSigningID() github_com_bandprotocol_chain_v2_pkg_tss.SigningID {
	if m != nil {
		return m.SigningID
	}
	return 0
...
// OracleResultRequestingSignature defines a request id to request TSS signature from the oracle result.
type OracleResultRequestingSignature struct {
	// RequestID is BandChain's unique identifier for this oracle request.
	RequestID RequestID `protobuf:"varint,1,opt,name=request_id,json=requestId,proto3,casttype=RequestID" json:"request_id,omitempty"`
...
func (m *OracleResultRequestingSignature) Reset()         { *m = OracleResultRequestingSignature{} }
func (m *OracleResultRequestingSignature) String() string { return proto.CompactTextString(m) }
func (*OracleResultRequestingSignature) ProtoMessage()    {}
func (*OracleResultRequestingSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_652b57db11528d07, []int{18}
}
func (m *OracleResultRequestingSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OracleResultRequestingSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OracleResultRequestingSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OracleResultRequestingSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OracleResultRequestingSignature.Merge(m, src)
}
func (m *OracleResultRequestingSignature) XXX_Size() int {
	return m.Size()
}
func (m *OracleResultRequestingSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_OracleResultRequestingSignature.DiscardUnknown(m)
}

var xxx_messageInfo_OracleResultRequestingSignature proto.InternalMessageInfo

func init() {
	proto.RegisterEnum("oracle.v1.ResolveStatus", ResolveStatus_name, ResolveStatus_value)
	proto.RegisterEnum("oracle.v1.EncodeType", EncodeType_name, EncodeType_value)
	...
	proto.RegisterType((*SigningResult)(nil), "oracle.v1.SigningResult")
	...
	proto.RegisterType((*OracleResultRequestingSignature)(nil), "oracle.v1.OracleResultRequestingSignature")
}
...
var fileDescriptor_652b57db11528d07 = []byte{
	...
	,
}
...
func (this *Request) Equal(that interface{}) bool {
	...
	if this.TSSGroupID != that1.TSSGroupID {
		return false
	}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TSSGroupID != 0 {
		i = encodeVarintOracle(dAtA, i, uint64(m.TSSGroupID))
		i--
		dAtA[i] = 0x58
	}
	if m.ExecuteGas != 0 {
...
func (m *OracleResultRequestingSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OracleResultRequestingSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OracleResultRequestingSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request) Size() (n int) {
	...
	if m.TSSGroupID != 0 {
		n += 1 + sovOracle(uint64(m.TSSGroupID))
	}
	if m.TSSEncodeType != 0 {
...
func (m *OracleResultRequestingSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TSSGroupID", wireType)
			}
			m.TSSGroupID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TSSGroupID |= github_com_bandprotocol_chain_v2_pkg_tss.GroupID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *OracleResultRequestingSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OracleResultRequestingSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OracleResultRequestingSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
