...
type Params struct {
	...
	// MaxConcurrentResolvingRequests is a parameter that define how much go routine
	// using for resolve request at end block time
	MaxConcurrentResolvingRequests uint64 `protobuf:"varint,12,opt,name=MaxConcurrentResolvingRequests,proto3" json:"MaxConcurrentResolvingRequests,omitempty"`
}
...
func (m *Params) GetMaxConcurrentResolvingRequests() uint64 {
	if m != nil {
		return m.MaxConcurrentResolvingRequests
	}
	return 0
}
...
var fileDescriptor_652b57db11528d07 = []byte{
	...
	0xd0, 0x30, 0x5a, 0x6c, 0x32, 0x20, 0xc4, 0xcc, 0xf2, 0xa1, 0xd8, 0x71, 0x16, 0xa3, 0x30, 0x63,
	0x3d, 0x27, 0x23, 0x84, 0x84, 0x5a, 0xcf, 0xdd, 0x2f, 0xce, 0x53, 0xfa, 0x8b, 0xf7, 0xda, 0x89,
	0xb3, 0x37, 0x6e, 0x68, 0x4f, 0x73, 0x41, 0xe2, 0xc0, 0x4a, 0x2b, 0xed, 0x8d, 0x2b, 0xe2, 0x1f,
	0xe0, 0xb4, 0x37, 0xf6, 0x84, 0x38, 0x79, 0x91, 0xe7, 0x02, 0x7f, 0x00, 0x17, 0xb8, 0xa0, 0xf7,
	0xd1, 0x6e, 0xdb, 0x64, 0x19, 0x26, 0x0b, 0x1c, 0x38, 0xc5, 0xf5, 0xab, 0xaa, 0xee, 0x7a, 0x55,
	0xbf, 0xaa, 0x57, 0x1d, 0xd8, 0x09, 0x39, 0x71, 0x3c, 0xda, 0xb8, 0xdc, 0x6f, 0xe8, 0x5f, 0xf5,
	...
	0x5a, 0xbf, 0xf7, 0x57, 0x0b, 0xe0, 0x90, 0xc4, 0xa4, 0x17, 0x0e, 0xb9, 0x43, 0xd1, 0x36, 0x2c,
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.MaxConcurrentResolvingRequests != that1.MaxConcurrentResolvingRequests {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxConcurrentResolvingRequests != 0 {
		i = encodeVarintOracle(dAtA, i, uint64(m.MaxConcurrentResolvingRequests))
		i--
		dAtA[i] = 0x60
	}
...
func (m *Params) Size() (n int) {
	...
	if m.MaxConcurrentResolvingRequests != 0 {
		n += 1 + sovOracle(uint64(m.MaxConcurrentResolvingRequests))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxConcurrentResolvingRequests", wireType)
			}
			m.MaxConcurrentResolvingRequests = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowOracle
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxConcurrentResolvingRequests |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
