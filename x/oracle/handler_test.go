...
func TestRequestDataSuccess(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, []byte("beeb"), 2, 2, "CID", testapp.EmptyCoins, testapp.Alice.Address, testapp.TestDefaultPrepareGas, testapp.TestDefaultExecuteGas)
	res, err := oracle.NewHandler(k)(ctx, msg)
	require.NoError(t, err)
	require.Equal(t, types.NewRequest(
		...
		nil,
		uint64(testapp.TestDefaultPrepareGas), uint64(testapp.TestDefaultExecuteGas),
...
func TestRequestDataFail(t *testing.T) {
	...
	res, err := oracle.NewHandler(k)(ctx, types.NewMsgRequestData(1, []byte("beeb"), 2, 2, "CID", testapp.EmptyCoins, testapp.Alice.Address, testapp.TestDefaultPrepareGas, testapp.TestDefaultExecuteGas))
	...
	// Too high ask count
	res, err = oracle.NewHandler(k)(ctx, types.NewMsgRequestData(1, []byte("beeb"), 3, 2, "CID", testapp.EmptyCoins, testapp.Alice.Address, testapp.TestDefaultPrepareGas, testapp.TestDefaultExecuteGas))
	// require.EqualError(t, err, "insufficent available validators: 2 < 3")
	require.Nil(t, res)
	// Bad oracle script ID
	res, err = oracle.NewHandler(k)(ctx, types.NewMsgRequestData(999, []byte("beeb"), 2, 2, "CID", testapp.EmptyCoins, testapp.Alice.Address, testapp.TestDefaultPrepareGas, testapp.TestDefaultExecuteGas))
	// require.EqualError(t, err, "oracle script not found: id: 999")
	_ = err
	require.Nil(t, res)
}
