...
// fail if any error occurs. The clientID's, TestConnections, and ibctesting.TestChannels are returned
...
func (coord *Coordinator) CreateTransferChannels(
	...
	return coord.CreateChannel(chainA, chainB, connA, connB, OraclePort, OraclePort, order)
}
