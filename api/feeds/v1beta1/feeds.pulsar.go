...
var _ protoreflect.List = (*_FeedsPriceData_1_list)(nil)

type _FeedsPriceData_1_list struct {
	list *[]*SignalPrice
}

func (x *_FeedsPriceData_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_FeedsPriceData_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_FeedsPriceData_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*SignalPrice)
	(*x.list)[i] = concreteValue
}

func (x *_FeedsPriceData_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*SignalPrice)
	*x.list = append(*x.list, concreteValue)
}

func (x *_FeedsPriceData_1_list) AppendMutable() protoreflect.Value {
	v := new(SignalPrice)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_FeedsPriceData_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_FeedsPriceData_1_list) NewElement() protoreflect.Value {
	v := new(SignalPrice)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_FeedsPriceData_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_FeedsPriceData              protoreflect.MessageDescriptor
	fd_FeedsPriceData_signalPrices protoreflect.FieldDescriptor
	fd_FeedsPriceData_timestamp    protoreflect.FieldDescriptor
)

func init() {
	file_feeds_v1beta1_feeds_proto_init()
	md_FeedsPriceData = File_feeds_v1beta1_feeds_proto.Messages().ByName("FeedsPriceData")
	fd_FeedsPriceData_signalPrices = md_FeedsPriceData.Fields().ByName("signalPrices")
	fd_FeedsPriceData_timestamp = md_FeedsPriceData.Fields().ByName("timestamp")
}

var _ protoreflect.Message = (*fastReflection_FeedsPriceData)(nil)

type fastReflection_FeedsPriceData FeedsPriceData

func (x *FeedsPriceData) ProtoReflect() protoreflect.Message {
	return (*fastReflection_FeedsPriceData)(x)
}

func (x *FeedsPriceData) slowProtoReflect() protoreflect.Message {
	mi := &file_feeds_v1beta1_feeds_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_FeedsPriceData_messageType fastReflection_FeedsPriceData_messageType
var _ protoreflect.MessageType = fastReflection_FeedsPriceData_messageType{}

type fastReflection_FeedsPriceData_messageType struct{}

func (x fastReflection_FeedsPriceData_messageType) Zero() protoreflect.Message {
	return (*fastReflection_FeedsPriceData)(nil)
}
func (x fastReflection_FeedsPriceData_messageType) New() protoreflect.Message {
	return new(fastReflection_FeedsPriceData)
}
func (x fastReflection_FeedsPriceData_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_FeedsPriceData
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_FeedsPriceData) Descriptor() protoreflect.MessageDescriptor {
	return md_FeedsPriceData
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_FeedsPriceData) Type() protoreflect.MessageType {
	return _fastReflection_FeedsPriceData_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_FeedsPriceData) New() protoreflect.Message {
	return new(fastReflection_FeedsPriceData)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_FeedsPriceData) Interface() protoreflect.ProtoMessage {
	return (*FeedsPriceData)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_FeedsPriceData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.SignalPrices) != 0 {
		value := protoreflect.ValueOfList(&_FeedsPriceData_1_list{list: &x.SignalPrices})
		if !f(fd_FeedsPriceData_signalPrices, value) {
			return
		}
	}
	if x.Timestamp != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Timestamp)
		if !f(fd_FeedsPriceData_timestamp, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_FeedsPriceData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "feeds.v1beta1.FeedsPriceData.signalPrices":
		return len(x.SignalPrices) != 0
	case "feeds.v1beta1.FeedsPriceData.timestamp":
		return x.Timestamp != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: feeds.v1beta1.FeedsPriceData"))
		}
		panic(fmt.Errorf("message feeds.v1beta1.FeedsPriceData does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FeedsPriceData) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "feeds.v1beta1.FeedsPriceData.signalPrices":
		x.SignalPrices = nil
	case "feeds.v1beta1.FeedsPriceData.timestamp":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_FeedsPriceData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "feeds.v1beta1.FeedsPriceData.signalPrices":
		if len(x.SignalPrices) == 0 {
			return protoreflect.ValueOfList(&_FeedsPriceData_1_list{})
		}
		listValue := &_FeedsPriceData_1_list{list: &x.SignalPrices}
		return protoreflect.ValueOfList(listValue)
	case "feeds.v1beta1.FeedsPriceData.timestamp":
		value := x.Timestamp
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message feeds.v1beta1.FeedsPriceData does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FeedsPriceData) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "feeds.v1beta1.FeedsPriceData.signalPrices":
		lv := value.List()
		clv := lv.(*_FeedsPriceData_1_list)
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FeedsPriceData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "feeds.v1beta1.FeedsPriceData.signalPrices":
		if x.SignalPrices == nil {
			x.SignalPrices = []*SignalPrice{}
		}
		value := &_FeedsPriceData_1_list{list: &x.SignalPrices}
		return protoreflect.ValueOfList(value)
	case "feeds.v1beta1.FeedsPriceData.timestamp":
		panic(fmt.Errorf("field timestamp of message feeds.v1beta1.FeedsPriceData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: feeds.v1beta1.FeedsPriceData"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_FeedsPriceData) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "feeds.v1beta1.FeedsPriceData.signalPrices":
		list := []*SignalPrice{}
		return protoreflect.ValueOfList(&_FeedsPriceData_1_list{list: &list})
	case "feeds.v1beta1.FeedsPriceData.timestamp":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
		if fd.IsExtension() {
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_FeedsPriceData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in feeds.v1beta1.FeedsPriceData", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_FeedsPriceData) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FeedsPriceData) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_FeedsPriceData) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_FeedsPriceData) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*FeedsPriceData)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: FeedsPriceData: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: FeedsPriceData: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func init() {
	file_feeds_v1beta1_feeds_proto_init()
	md_FeedsSignatureOrder = File_feeds_v1beta1_feeds_proto.Messages().ByName("FeedsSignatureOrder")
...
func (x *FeedsSignatureOrder) slowProtoReflect() protoreflect.Message {
	mi := &file_feeds_v1beta1_feeds_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_FeedsSignatureOrder) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "feeds.v1beta1.FeedsSignatureOrder.signal_ids":
		return len(x.SignalIds) != 0
	case "feeds.v1beta1.FeedsSignatureOrder.encoder":
		return x.Encoder != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: feeds.v1beta1.FeedsSignatureOrder"))
		}
		panic(fmt.Errorf("message feeds.v1beta1.FeedsSignatureOrder does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_FeedsSignatureOrder) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message feeds.v1beta1.FeedsSignatureOrder does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_FeedsSignatureOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "feeds.v1beta1.FeedsSignatureOrder.signal_ids":
		...
		return protoreflect.ValueOfList(value)
	case "feeds.v1beta1.FeedsSignatureOrder.encoder":
		panic(fmt.Errorf("field encoder of message feeds.v1beta1.FeedsSignatureOrder is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: feeds.v1beta1.FeedsSignatureOrder"))
		}
...
func (x *fastReflection_FeedsSignatureOrder) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in feeds.v1beta1.FeedsSignatureOrder", d.FullName()))
	}
	panic("unreachable")
}
...
func (Encoder) Descriptor() protoreflect.EnumDescriptor {
	return file_feeds_v1beta1_feeds_proto_enumTypes[1].Descriptor()
}

func (Encoder) Type() protoreflect.EnumType {
	return &file_feeds_v1beta1_feeds_proto_enumTypes[1]
}
...
type FeedsPriceData struct {
	...
	SignalPrices []*SignalPrice `protobuf:"bytes,1,rep,name=signalPrices,proto3" json:"signalPrices,omitempty"`
	// Timestamp is the timestamp at which the price was submitted.
	Timestamp uint64 `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
}

func (x *FeedsPriceData) Reset() {
	*x = FeedsPriceData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feeds_v1beta1_feeds_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *FeedsPriceData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FeedsPriceData) ProtoMessage() {}

// Deprecated: Use FeedsPriceData.ProtoReflect.Descriptor instead.
func (*FeedsPriceData) Descriptor() ([]byte, []int) {
	return file_feeds_v1beta1_feeds_proto_rawDescGZIP(), []int{11}
}

func (x *FeedsPriceData) GetSignalPrices() []*SignalPrice {
	if x != nil {
...
func (x *FeedsPriceData) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type FeedsSignatureOrder struct {
	...
	Encoder Encoder `protobuf:"varint,2,opt,name=encoder,proto3,enum=feeds.v1beta1.Encoder" json:"encoder,omitempty"`
}
...
func (*FeedsSignatureOrder) Descriptor() ([]byte, []int) {
	return file_feeds_v1beta1_feeds_proto_rawDescGZIP(), []int{12}
}
...
var file_feeds_v1beta1_feeds_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xf5, 0x01, 0x0a, 0x0e, 0x56, 0x61,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x29, 0x0a, 0x09, 0x73, 0x69, 0x67,
	0x6e, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0c, 0xe2, 0xde,
	0x1f, 0x08, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x49, 0x44, 0x52, 0x08, 0x73, 0x69, 0x67, 0x6e,
	0x61, 0x6c, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69,
	...
	,
	...
	,
	...
	,
...
var file_feeds_v1beta1_feeds_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_feeds_v1beta1_feeds_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_feeds_v1beta1_feeds_proto_goTypes = []interface{}{
	(PriceStatus)(0),                  // 0: feeds.v1beta1.PriceStatus
	(Encoder)(0),                      // 1: feeds.v1beta1.Encoder
	(*Signal)(nil),                    // 2: feeds.v1beta1.Signal
	(*DelegatorSignals)(nil),          // 3: feeds.v1beta1.DelegatorSignals
	(*Feed)(nil),                      // 4: feeds.v1beta1.Feed
	(*FeedWithDeviation)(nil),         // 5: feeds.v1beta1.FeedWithDeviation
	(*CurrentFeeds)(nil),              // 6: feeds.v1beta1.CurrentFeeds
	(*CurrentFeedWithDeviations)(nil), // 7: feeds.v1beta1.CurrentFeedWithDeviations
	(*Price)(nil),                     // 8: feeds.v1beta1.Price
	(*SignalPrice)(nil),               // 9: feeds.v1beta1.SignalPrice
	(*ValidatorPrice)(nil),            // 10: feeds.v1beta1.ValidatorPrice
	(*ValidatorPriceList)(nil),        // 11: feeds.v1beta1.ValidatorPriceList
	(*ReferenceSourceConfig)(nil),     // 12: feeds.v1beta1.ReferenceSourceConfig
	(*FeedsPriceData)(nil),            // 13: feeds.v1beta1.FeedsPriceData
	(*FeedsSignatureOrder)(nil),       // 14: feeds.v1beta1.FeedsSignatureOrder
}
var file_feeds_v1beta1_feeds_proto_depIdxs = []int32{
	2,  // 0: feeds.v1beta1.DelegatorSignals.signals:type_name -> feeds.v1beta1.Signal
	4,  // 1: feeds.v1beta1.CurrentFeeds.feeds:type_name -> feeds.v1beta1.Feed
	5,  // 2: feeds.v1beta1.CurrentFeedWithDeviations.feeds:type_name -> feeds.v1beta1.FeedWithDeviation
	...
	10, // 6: feeds.v1beta1.ValidatorPriceList.validator_prices:type_name -> feeds.v1beta1.ValidatorPrice
	9,  // 7: feeds.v1beta1.FeedsPriceData.signalPrices:type_name -> feeds.v1beta1.SignalPrice
	1,  // 8: feeds.v1beta1.FeedsSignatureOrder.encoder:type_name -> feeds.v1beta1.Encoder
...
func file_feeds_v1beta1_feeds_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_feeds_v1beta1_feeds_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FeedsPriceData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_feeds_v1beta1_feeds_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
