...
var (
	...
	fd_Packet_route_result protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Packet_route_result = md_Packet.Fields().ByName("route_result")
...
func (x *fastReflection_Packet) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.RouteResult != nil {
		value := protoreflect.ValueOfMessage(x.RouteResult.ProtoReflect())
		if !f(fd_Packet_route_result, value) {
			return
		}
	}
	if len(x.BaseFee) != 0 {
...
func (x *fastReflection_Packet) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "band.tunnel.v1beta1.Packet.prices":
		return len(x.Prices) != 0
	case "band.tunnel.v1beta1.Packet.route_result":
		return x.RouteResult != nil
...
func (x *fastReflection_Packet) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "band.tunnel.v1beta1.Packet.prices":
		...
		x.Prices = *clv.list
	case "band.tunnel.v1beta1.Packet.route_result":
		x.RouteResult = value.Message().Interface().(*anypb.Any)
	case "band.tunnel.v1beta1.Packet.base_fee":
		lv := value.List()
...
func (x *fastReflection_Packet) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "band.tunnel.v1beta1.Packet.route_result":
		if x.RouteResult == nil {
			x.RouteResult = new(anypb.Any)
		}
		return protoreflect.ValueOfMessage(x.RouteResult.ProtoReflect())
	case "band.tunnel.v1beta1.Packet.base_fee":
		if x.BaseFee == nil {
...
func (x *fastReflection_Packet) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.RouteResult != nil {
			encoded, err := options.Marshal(x.RouteResult)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RouteResult", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.RouteResult == nil {
					x.RouteResult = &anypb.Any{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.RouteResult); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 5:
...
type Packet struct {
	...
	RouteResult *anypb.Any `protobuf:"bytes,4,opt,name=route_result,json=routeResult,proto3" json:"route_result,omitempty"`
...
func (x *Packet) GetRouteResult() *anypb.Any {
	if x != nil {
...
var file_band_tunnel_v1beta1_tunnel_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xc4, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x63,
	...
	0x63, 0x65, 0x73, 0x12, 0x49, 0x0a, 0x0c, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x72, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x42,
	0x10, 0xca, 0xb4, 0x2d, 0x0c, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x49, 0x52, 0x0b, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x66,
	0x0a, 0x08, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	...
	0x6b, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x07, 0x62,
	0x61, 0x73, 0x65, 0x46, 0x65, 0x65, 0x12, 0x68, 0x0a, 0x09, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f,
	0x66, 0x65, 0x65, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x08, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x46, 0x65, 0x65,
	...
	0xdc, 0x01, 0x0a, 0x07, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x29, 0x0a, 0x09, 0x74,
	...
	0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x09, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69,
	...
	,
...
var file_band_tunnel_v1beta1_tunnel_proto_depIdxs = []int32{
	...
	6,  // 7: band.tunnel.v1beta1.Packet.route_result:type_name -> google.protobuf.Any
