...
var (
	...
	fd_LatestSignalPrices_last_interval_timestamp protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_LatestSignalPrices_last_interval_timestamp = md_LatestSignalPrices.Fields().ByName("last_interval_timestamp")
}
...
func (x *fastReflection_LatestSignalPrices) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.LastIntervalTimestamp != int64(0) {
		value := protoreflect.ValueOfInt64(x.LastIntervalTimestamp)
		if !f(fd_LatestSignalPrices_last_interval_timestamp, value) {
			return
		}
	}
}
...
func (x *fastReflection_LatestSignalPrices) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "band.tunnel.v1beta1.LatestSignalPrices.last_interval_timestamp":
		return x.LastIntervalTimestamp != int64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_LatestSignalPrices) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "band.tunnel.v1beta1.LatestSignalPrices.signal_prices":
		x.SignalPrices = nil
	case "band.tunnel.v1beta1.LatestSignalPrices.last_interval_timestamp":
		x.LastIntervalTimestamp = int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: band.tunnel.v1beta1.LatestSignalPrices"))
		}
...
func (x *fastReflection_LatestSignalPrices) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "band.tunnel.v1beta1.LatestSignalPrices.last_interval_timestamp":
		x.LastIntervalTimestamp = value.Int()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: band.tunnel.v1beta1.LatestSignalPrices"))
		}
...
func (x *fastReflection_LatestSignalPrices) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "band.tunnel.v1beta1.LatestSignalPrices.last_interval_timestamp":
		panic(fmt.Errorf("field last_interval_timestamp of message band.tunnel.v1beta1.LatestSignalPrices is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: band.tunnel.v1beta1.LatestSignalPrices"))
		}
...
func (x *fastReflection_LatestSignalPrices) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.LastIntervalTimestamp != 0 {
			n += 1 + runtime.Sov(uint64(x.LastIntervalTimestamp))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.LastIntervalTimestamp != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.LastIntervalTimestamp))
			i--
			dAtA[i] = 0x18
		}
		if len(x.SignalPrices) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field LastIntervalTimestamp", wireType)
				}
				x.LastIntervalTimestamp = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.LastIntervalTimestamp |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *LatestSignalPrices) GetLastIntervalTimestamp() int64 {
	if x != nil {
		return x.LastIntervalTimestamp
	}
	return 0
}
...
var file_band_tunnel_v1beta1_tunnel_proto_rawDesc = []byte{
	...
	0xca, 0x01, 0x0a, 0x12, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c,
	...
	0x52, 0x0c, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x73, 0x12, 0x36,
	0x0a, 0x17, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x15, 0x6c, 0x61, 0x73, 0x74, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x54, 0x69, 0x6d,
	...
	0x63, 0x6b, 0x65, 0x74, 0x46, 0x65, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x8c, 0x02,
	...
	0x4b, 0x0a, 0x0d, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x62, 0x61, 0x6e, 0x64, 0x2e, 0x74, 0x75,
	...
	,
