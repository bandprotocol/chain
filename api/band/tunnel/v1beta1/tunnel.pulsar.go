...
func (x *fastReflection_TunnelSignatureOrder) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "band.tunnel.v1beta1.TunnelSignatureOrder.created_at":
		x.CreatedAt = value.Int()
	case "band.tunnel.v1beta1.TunnelSignatureOrder.encoder":
		x.Encoder = (TSSRouteEncoder)(value.Enum())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: band.tunnel.v1beta1.TunnelSignatureOrder"))
		}
		...
		for iNdEx < l {
			...
			case 4:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.Encoder |= TSSRouteEncoder(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
// TSSRouteEncoder is an enumerator that defines the mode of encoding packet data of TSS route.
type TSSRouteEncoder int32

const (
	// TSS_ROUTE_ENCODER_UNSPECIFIED is an unspecified encoder mode.
	TSSRouteEncoder_TSS_ROUTE_ENCODER_UNSPECIFIED TSSRouteEncoder = 0
	// TSS_ROUTE_ENCODER_FIXED_POINT_ABI is a fixed-point price abi encoder (price * 10^9).
	TSSRouteEncoder_TSS_ROUTE_ENCODER_FIXED_POINT_ABI TSSRouteEncoder = 1
	// TSS_ROUTE_ENCODER_TICK_ABI is a tick abi encoder.
	TSSRouteEncoder_TSS_ROUTE_ENCODER_TICK_ABI TSSRouteEncoder = 2
)

// Enum value maps for TSSRouteEncoder.
var (
	TSSRouteEncoder_name = map[int32]string{
		0: "TSS_ROUTE_ENCODER_UNSPECIFIED",
		1: "TSS_ROUTE_ENCODER_FIXED_POINT_ABI",
		2: "TSS_ROUTE_ENCODER_TICK_ABI",
	}
	TSSRouteEncoder_value = map[string]int32{
		"TSS_ROUTE_ENCODER_UNSPECIFIED":     0,
		"TSS_ROUTE_ENCODER_FIXED_POINT_ABI": 1,
		"TSS_ROUTE_ENCODER_TICK_ABI":        2,
	}
)

func (x TSSRouteEncoder) Enum() *TSSRouteEncoder {
	p := new(TSSRouteEncoder)
	*p = x
	return p
}

func (x TSSRouteEncoder) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TSSRouteEncoder) Descriptor() protoreflect.EnumDescriptor {
	return file_band_tunnel_v1beta1_tunnel_proto_enumTypes[0].Descriptor()
}

func (TSSRouteEncoder) Type() protoreflect.EnumType {
	return &file_band_tunnel_v1beta1_tunnel_proto_enumTypes[0]
}

func (x TSSRouteEncoder) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TSSRouteEncoder.Descriptor instead.
func (TSSRouteEncoder) EnumDescriptor() ([]byte, []int) {
...
type TunnelSignatureOrder struct {
	...
	Encoder TSSRouteEncoder `protobuf:"varint,4,opt,name=encoder,proto3,enum=band.tunnel.v1beta1.TSSRouteEncoder" json:"encoder,omitempty"`
}
...
func (x *TunnelSignatureOrder) GetEncoder() TSSRouteEncoder {
	if x != nil {
		return x.Encoder
	}
	return TSSRouteEncoder_TSS_ROUTE_ENCODER_UNSPECIFIED
}
...
var file_band_tunnel_v1beta1_tunnel_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8d, 0x04, 0x0a, 0x06, 0x54, 0x75, 0x6e, 0x6e, 0x65,
	...
	0x09, 0x66, 0x65, 0x65, 0x5f, 0x70, 0x61, 0x79, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x18, 0xd2, 0xb4, 0x2d, 0x14, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x08, 0x66, 0x65, 0x65, 0x50,
	0x61, 0x79, 0x65, 0x72, 0x12, 0x57, 0x0a, 0x11, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x5f, 0x64,
	0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x75, 0x0a, 0x0d, 0x74, 0x6f, 0x74,
	0x61, 0x6c, 0x5f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xd2,
	0xb4, 0x2d, 0x14, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72,
	0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x9d, 0x01, 0x0a, 0x0c, 0x4c, 0x61, 0x74, 0x65, 0x73,
	0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x73, 0x12, 0x29, 0x0a, 0x09, 0x74, 0x75, 0x6e, 0x6e, 0x65,
	...
	0x49, 0x64, 0x12, 0x37, 0x0a, 0x06, 0x70, 0x72, 0x69, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03,
	...
	0xde, 0x1f, 0x00, 0x52, 0x06, 0x70, 0x72, 0x69, 0x63, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x6c,
	0x61, 0x73, 0x74, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0c, 0x6c, 0x61, 0x73, 0x74, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x91, 0x01, 0x0a, 0x09, 0x54, 0x6f, 0x74, 0x61, 0x6c,
	0x46, 0x65, 0x65, 0x73, 0x12, 0x7e, 0x0a, 0x15, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x62, 0x61,
	0x73, 0x65, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x01, 0x20,
	...
	0x52, 0x12, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x61, 0x73, 0x65, 0x50, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x46, 0x65, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xbd, 0x03, 0x0a, 0x06, 0x50,
	...
	0x72, 0x69, 0x63, 0x65, 0x73, 0x12, 0x42, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74,
	...
	0x2d, 0x0e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x49,
	0x52, 0x07, 0x72, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x12, 0x66, 0x0a, 0x08, 0x62, 0x61, 0x73,
	0x65, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f,
	...
	0x65, 0x73, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x07, 0x62, 0x61, 0x73, 0x65, 0x46, 0x65,
	0x65, 0x12, 0x68, 0x0a, 0x09, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x06,
	...
	0x73, 0x52, 0x08, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x46, 0x65, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x63,
	...
	0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xd0, 0x01, 0x0a, 0x14, 0x54, 0x75, 0x6e, 0x6e, 0x65,
	...
	,
...
var file_band_tunnel_v1beta1_tunnel_proto_goTypes = []interface{}{
	(TSSRouteEncoder)(0),         // 0: band.tunnel.v1beta1.TSSRouteEncoder
	(*Tunnel)(nil),               // 1: band.tunnel.v1beta1.Tunnel
	(*LatestPrices)(nil),         // 2: band.tunnel.v1beta1.LatestPrices
	(*TotalFees)(nil),            // 3: band.tunnel.v1beta1.TotalFees
	(*Packet)(nil),               // 4: band.tunnel.v1beta1.Packet
	(*Deposit)(nil),              // 5: band.tunnel.v1beta1.Deposit
	(*SignalDeviation)(nil),      // 6: band.tunnel.v1beta1.SignalDeviation
	(*TunnelSignatureOrder)(nil), // 7: band.tunnel.v1beta1.TunnelSignatureOrder
...
var file_band_tunnel_v1beta1_tunnel_proto_depIdxs = []int32{
	8,  // 0: band.tunnel.v1beta1.Tunnel.route:type_name -> google.protobuf.Any
	6,  // 1: band.tunnel.v1beta1.Tunnel.signal_deviations:type_name -> band.tunnel.v1beta1.SignalDeviation
	9,  // 2: band.tunnel.v1beta1.Tunnel.total_deposit:type_name -> cosmos.base.v1beta1.Coin
	10, // 3: band.tunnel.v1beta1.LatestPrices.prices:type_name -> band.feeds.v1beta1.Price
	9,  // 4: band.tunnel.v1beta1.TotalFees.total_base_packet_fee:type_name -> cosmos.base.v1beta1.Coin
	10, // 5: band.tunnel.v1beta1.Packet.prices:type_name -> band.feeds.v1beta1.Price
	8,  // 6: band.tunnel.v1beta1.Packet.receipt:type_name -> google.protobuf.Any
	9,  // 7: band.tunnel.v1beta1.Packet.base_fee:type_name -> cosmos.base.v1beta1.Coin
	9,  // 8: band.tunnel.v1beta1.Packet.route_fee:type_name -> cosmos.base.v1beta1.Coin
	9,  // 9: band.tunnel.v1beta1.Deposit.amount:type_name -> cosmos.base.v1beta1.Coin
	10, // 10: band.tunnel.v1beta1.TunnelSignatureOrder.prices:type_name -> band.feeds.v1beta1.Price
	0,  // 11: band.tunnel.v1beta1.TunnelSignatureOrder.encoder:type_name -> band.tunnel.v1beta1.TSSRouteEncoder
