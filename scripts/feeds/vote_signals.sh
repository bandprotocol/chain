...
# vote
bandd tx feeds vote CS:BTC-USD,30000000000 CS:USDT-USD,30000000000 --from validator --keyring-backend test --gas-prices 0.0025uband -y --chain-id bandchain
bandd tx feeds vote CS:BTC-USD,30000000000 CS:USDT-USD,29000000000 --from requester --keyring-backend test --gas-prices 0.0025uband -y --chain-id bandchain
