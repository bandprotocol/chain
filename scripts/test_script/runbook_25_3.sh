...
./scripts/test_script/setup_chains.sh /Users/ongart/Development/band/chain v2.5.4 upgrade-handler-v3 v3

./scripts/test_script/start_cosmovisor.sh

# then run the ./scripts/test_script/open_vote_proposal_25.sh v3