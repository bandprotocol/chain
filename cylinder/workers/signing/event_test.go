	...
	}{
		{
			...
			sdk.NewABCIMessageLog(0, "", sdk.Events{
				sdk.NewEvent(
					...
					sdk.NewAttribute(types.AttributeKeyOwnBindingFactor, "aaaaa2"),
					sdk.NewAttribute(types.AttributeKeyOwnPubNonces, "aaaaa2"),
					...
					sdk.NewAttribute(types.AttributeKeyOwnBindingFactor, "aaaaa5"),
					sdk.NewAttribute(types.AttributeKeyOwnPubNonces, "aaaaa6"),
