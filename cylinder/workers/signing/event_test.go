	...
	}{
		{
			...
			sdk.NewABCIMessageLog(0, "", sdk.Events{
				sdk.NewEvent(
					...
					sdk.NewAttribute(types.AttributeKeyPubNonces, hex.EncodeToString([]byte("pubNonce1"))),
					...
					sdk.NewAttribute(types.AttributeKeyPubNonces, hex.EncodeToString([]byte("pubNonce2"))),
