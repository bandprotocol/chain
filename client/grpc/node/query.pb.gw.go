...
var (
	pattern_Service_ChainID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bandchain", "v1", "chain_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_EVMValidators_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bandchain", "v1", "evm-validators"}, "", runtime.AssumeColonVerbOpt(true)))
)
